  ...
  return (
    <div className="space-y-7">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Trainer Program</CardTitle><a href="/admin/trainer-program" className="text-sm font-semibold text-teal-700 hover:underline">Manage program →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Course modules, trainer assignments, proposals, teach requests, deliverables, and payouts.</p></CardContent></Card>
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Course Enrollments</CardTitle><a href="/admin/course-enrollments" className="text-sm font-semibold text-teal-700 hover:underline">Manage enrollments →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Enroll a student once their off-platform course payment is confirmed to unlock that course&apos;s modules.</p></CardContent></Card>
      </div>
      <Card>
