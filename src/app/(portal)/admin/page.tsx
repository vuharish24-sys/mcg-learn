  ...
  return (
    <div className="space-y-7">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Program Benefits</CardTitle><a href="/admin/benefits" className="text-sm font-semibold text-teal-700 hover:underline">Manage benefits →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Coupons, scholarships, and perks with their own expiry — map them onto specific program tiers/modes.</p></CardContent></Card>
        ...
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Bundles</CardTitle><a href="/admin/bundles" className="text-sm font-semibold text-teal-700 hover:underline">Manage bundles →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Combine paid learning paths into a package sold at one price via Razorpay.</p></CardContent></Card>
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Trainer Program</CardTitle><a href="/admin/trainer-program" className="text-sm font-semibold text-teal-700 hover:underline">Manage program →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Program modules, trainer assignments, proposals, teach requests, deliverables, and payouts.</p></CardContent></Card>
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Program Enrollments</CardTitle><a href="/admin/course-enrollments" className="text-sm font-semibold text-teal-700 hover:underline">Manage enrollments →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Enroll a student once their off-platform program payment is confirmed to unlock that program&apos;s modules.</p></CardContent></Card>
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Tutor LMS Courses</CardTitle><a href="/admin/tutor-lms-courses" className="text-sm font-semibold text-teal-700 hover:underline">Manage courses →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Map LMS Course feed items to a WordPress/Tutor LMS course and set a price.</p></CardContent></Card>
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Tutor Sessions</CardTitle><a href="/admin/tutor-sessions" className="text-sm font-semibold text-teal-700 hover:underline">Manage requests →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Quote a price for on-demand session requests, or decline them.</p></CardContent></Card>
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Installment Plans</CardTitle><a href="/admin/installment-plans" className="text-sm font-semibold text-teal-700 hover:underline">Manage plans →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Let a learner pay for a course, module, or lesson in parts.</p></CardContent></Card>
      </div>
      <Card>
