  ...
  return (
    <div className="space-y-7">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card><CardHeader className="flex flex-row items-center justify-between"><CardTitle>Moodle Courses</CardTitle><a href="/admin/moodle-courses" className="text-sm font-semibold text-teal-700 hover:underline">Manage courses →</a></CardHeader><CardContent><p className="text-sm text-slate-500">Map LMS Course feed items to Moodle, set a price, and configure the LTI launch URL.</p></CardContent></Card>
